...
public class SwaggerConfig
{
    ...
    {
        return new ApiInfoBuilder().title("Doc Title").contact(new Contact("demo", "", "dorosdebby@gmail.com"))
                                   .description("Doc description").termsOfServiceUrl("NO terms of service")
