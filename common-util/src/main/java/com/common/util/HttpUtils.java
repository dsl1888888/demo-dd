...
/**
 * HttpUtils帮助类 User: PunkLin林克澎 Email: lentr@sina.cn Date: 2017-04-04
 */
public class HttpUtils
{
     ...
     * @throws Exception
     */
    public static String post(String url, Map<String, ? extends Object> params, Map<String, String> headers) throws Exception
    {
        if (url == null || url.trim().length() == 0)
        {
            throw new Exception(TAG + ":url is null or empty!");
    ...
    public static void main(String[] args)
    {
        try
        {
//            System.out.println(get("http://144.34.247.64:999/11java-env.txt"));
            System.out.println(post("http://144.34.247.64:999/11java-env.txt"));
        }
        catch (Exception e)
        {
